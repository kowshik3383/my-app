...
const roles = [
  {
    ...
    label: "Mother",
    icon: Heart,
    description: "Caring & nurturing",
  },
  {
    value: "father",
    label: "Father",
    icon: UserRound,
    description: "Supportive & wise",
  },
  {
    value: "sister",
    label: "Sister",
  ...
  },
  {
    ...
    label: "Brother",
    icon: Users,
    description: "Protective & reliable",
  },
  {
    value: "grandparent",
    label: "Grandparent",
    icon: Heart,
    description: "Loving & experienced",
  },

  {
    ...
    label: "Doctor",
    icon: Stethoscope,
    description: "Professional & knowledgeable",
  },
  {
    value: "therapist",
    label: "Therapist",
    icon: Brain,
    description: "Supportive & insightful",
  },
  {
    value: "nurse",
    label: "Nurse",
    icon: Activity,
    description: "Compassionate & attentive",
  },

  {
    ...
    label: "Coach",
    icon: Trophy,
    description: "Motivating & disciplined",
  },
  {
    value: "mentor",
    label: "Mentor",
    icon: GraduationCap,
    description: "Guiding & experienced",
  },
  {
    value: "teacher",
    label: "Teacher",
    icon: BookOpen,
    description: "Educating & patient",
  },

  {
    ...
    label: "Friend",
    icon: MessageCircle,
    description: "Loyal & supportive",
  },
  {
    value: "best_friend",
    label: "Best Friend",
    icon: Sparkles,
    description: "Fun & trustworthy",
  },
  {
    value: "girlfriend",
    label: "Girlfriend",
    icon: Heart,
    description: "Loving & affectionate",
  },
  {
    value: "partner",
    label: "Partner",
    icon: HeartHandshake,
    description: "Committed & supportive",
  },

  {
    ...
    label: "Leader",
    icon: Crown,
    description: "Confident & inspiring",
  },
  {
    value: "boss",
    label: "Boss",
  ...
  },
  {
    ...
    label: "Teammate",
    icon: Users2,
    description: "Collaborative & dependable",
  },

  {
    value: "spiritual_guide",
    label: "Spiritual Guide",
    icon: Sun,
    description: "Calm & enlightening",
  },
  {
    value: "motivator",
    label: "Motivator",
...
const modulations = [
  ...
  {
    value: "strict_motivational",
    label: "Strict & Motivational",
    icon: Zap,
    description: "Direct and inspiring",
  },
  {
    value: "professional",
    label: "Professional",
    icon: Briefcase,
    description: "Clear and evidence-based",
  },
  {
    value: "energetic",
    label: "Energetic",
...
const diseases = [
  ...
  },
  {
    ...
    label: "Custom Topic",
    icon: Globe,
    description: "Your specific need",
  },
] as const;
...
export default function Onboarding() {
  ...
  const [selectedModulation, setSelectedModulation] =
    useState<AIModulation | null>(null);
  const [selectedLanguage, setSelectedLanguage] = useState<Language>("en");
  const [selectedDisease, setSelectedDisease] = useState<DiseaseFocus | null>(
    null,
  );
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 3:
        return true; // language always selected
      case 4:
        return (
          !!selectedDisease &&
          (selectedDisease !== "custom" || customTopic.trim().length > 0)
        );
      case 5:
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Select the role that resonates with you
                </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {roles.map((role) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-7 h-7 mx-auto mb-2.5 ${isSelected ? "text-green-600" : "text-gray-500"}`}
                      />
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  How should your companion speak to you?
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {modulations.map((mod) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-7 h-7 mb-2.5 ${isSelected ? "text-blue-600" : "text-gray-500"}`}
                      />
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Your companion will speak in this language
                </p>
              </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Your companion will remember and focus on this area
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {diseases.map((disease) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-7 h-7 mb-2.5 ${isSelected ? "text-green-600" : "text-gray-500"}`}
                      />
                      <p className="font-semibold text-gray-900 mb-0.5">
                        {disease.label}
                      </p>
